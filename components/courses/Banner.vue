<template>
  <div class="banner">
    ...
    <Button sp style="margin-right: 30px;">Подобрать курс&nbsp;&nbsp;&nbsp;›</Button>
...
.banner {
  position: relative;
  z-index: 11;
  //background: linear-gradient(275.31deg, #2E2B88 -3.51%, #383585 48.21%, #0B104F 98.45%, #514E9C 144.83%);
  background: linear-gradient(275.31deg, #514E9C -3.51%, #0B104F 48.21%, #383585 98.45%, #2E2B88 144.83%);
  padding: 73px 60px;
  border-radius: 50px;
  img {
    position: absolute;
