    ...
    const blocks = [
      {
        icon: icon1,
        title: 'Все',
        desc: 'учителя с <b>высшим, профильным образованием</b>'
      },
      {
        icon: icon2,
        title: '53%',
        desc: 'семей <b>привели своих <br> друзей</b>'
      },
      {
        icon: icon3,
        title: '>1000',
        desc: 'детей <b>от 8 до 17 лет в 30 странах мира</b> с нами'
      },
      {
        icon: icon4,
        title: '92%',
        desc: 'детей <b>остались с нами <br> после первого занятия</b>'
      }
    ]
